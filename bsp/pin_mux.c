...
void BOARD_InitPins_Core0(void)
{
    ...
    /* Flexcomm Interface 5: USART TXD */ /* UART_TX - arduino */
    IOCON_PinMuxSet(IOCON, PORT0_IDX, PIN18_IDX, IOCON_FUNC1 | IOCON_MODE_INACT | IOCON_DIGITAL_EN | IOCON_INPFILT_OFF);
    /* Flexcomm Interface 5: USART RXD */ /* UART_RX - arduino */
    IOCON_PinMuxSet(IOCON, PORT0_IDX, PIN20_IDX, IOCON_FUNC1 | IOCON_MODE_INACT | IOCON_DIGITAL_EN | IOCON_INPFILT_OFF);

    /* ADC0_3  */ /* ADC - Potentiometer */
	IOCON_PinMuxSet(IOCON, PORT1_IDX, PIN0_IDX, IOCON_FUNC0 | IOCON_MODE_INACT | IOCON_ANALOG_EN | IOCON_INPFILT_OFF);
